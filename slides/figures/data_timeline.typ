...
#let data-timeline = canvas(length: 1.2cm, {
  import draw: *
  ...
  // ── Quarterly GDP ──────────────────────────────
  // Q1 2020: Jan–Mar; Q2 2020: Apr–May (partial, Q2 ends in Jun)
  ...
  for f in s-fracs {
    ...
    circle((sx, ys + rh - 0.12), radius: 0.088, fill: c-s, stroke: none)
  }
  ...
  // Visible part of bracket (Jan → Apr)
  ...
  // Dashed arrow going left — 12-month window extends off-screen
  ...
  // ── Merge arrows at right-third of Feb ─────────────────────────
  let ax = 1.0 * mw + mw * 0.68

  line((ax, ys),     (ax, yd + rh + 0.05), stroke: (paint: c-ar, thickness: 0.5pt, dash: "dashed"), mark: (end: "stealth", scale: 0.40))
  line((ax, yd),     (ax, yq + rh + 0.05), stroke: (paint: c-ar, thickness: 0.5pt, dash: "dashed"), mark: (end: "stealth", scale: 0.40))
  line((ax, yq),     (ax, ym + rh + 0.05), stroke: (paint: c-ar, thickness: 0.5pt, dash: "dashed"), mark: (end: "stealth", scale: 0.40))
